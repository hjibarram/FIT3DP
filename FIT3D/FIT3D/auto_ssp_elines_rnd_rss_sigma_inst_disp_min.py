...
#
            ...
            if med_flux > CUT_MEDIAN_FLUX:
                ...
                if ns > 0:
                    ...
                    for ist in range(0,ns):
                        ...
                        ssp.print_a_final_file_add(n_mod,a_final,typef,chi_sq_now,out_fit_spectra,jy)
    ...
    f.close
    print str(jy)+"/"+str(NY)+" DONE"+" "+str(ML)
#
# End of the RSS loop!
#
# Write output file
