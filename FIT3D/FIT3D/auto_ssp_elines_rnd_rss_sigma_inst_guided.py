...
import matplotlib
from astropy.wcs.docstrings import crpix
matplotlib.use('Agg')
...
#
    ...
    if med_flux > CUT_MEDIAN_FLUX and med_flux > ABS_MIN:
        ...
        pdl_chi_now=((pdl_masked*pdl_res_JOINT)**2)/((np.array(e_flux_unc))**4.0)
