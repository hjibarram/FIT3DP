...
#sycall(call)
call="mkdir -p "+DIR_PLOTS+"/"+NAME
sycall(call)


call="plot_maps.py "+DIR_DATA_OUT_final+"/map.6530_6630."+NAME+"_flux_00.fits.gz 0 3 1 1 Ha,"+NAME+" 1 "+DIR_PLOTS+"/"+NAME+"/Ha_flux_"+NAME+".pdf"
mycall(call)
call="plot_maps.py "+DIR_DATA_OUT_final+"/"+NAME+".V.fits.gz 0 0.5 1 1 V,"+NAME+" 1 "+DIR_PLOTS+"/"+NAME+"/V_flux_"+NAME+".pdf"
mycall(call)
call="plot_maps.py "+DIR_DATA_OUT_final+"/map.6530_6630."+NAME+"_vel_00.fits.gz 7400 7700 1 1 VEL,"+NAME+" 1 "+DIR_PLOTS+"/"+NAME+"/Ha_vel_"+NAME+".pdf"
mycall(call)
