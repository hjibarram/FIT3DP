        ...
        while MIN_CHISQ > MIN_DELTA_CHISQ and NITER < MAX_NITER:
            ...
            if med_flux > CUT_MEDIAN_FLUX:
                ...
                if ns > 0:
                    ...
                    [min_chi_sq,pdl_age_mod,pdl_met_mod,pdl_ml,pdl_Av,coeffs,coeffs_N,coeffs_NM,pdl_mod_SSP,pdl_res_SSP,coeffs_N_input,e_coeffs_N_input]=ssp.fit_ssp_lin_MC(redshift,sigma,Av,crval1,cdelt1,crpix1,nf,n_c,pdl_flux_c_ini,hdr,wave_unc,masked,e_flux_unc,flux_unc,n_mc,chi_sq_min_now,MIN_CHISQ,plot)
